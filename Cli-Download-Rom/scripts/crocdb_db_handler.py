# Cli-Download-Rom/scripts/crocdb_db_handler.py
...
class CrocDBLocalHandler:
    ...
    def search_rom(self, query):
        """
        Busca por ROMs no DB local. Isso pode ser lento, pois varre todos os arquivos.

        Args:
            query (str): O termo para a busca (case-insensitive).

        Returns:
            list: Uma lista de dicionários com os resultados.
        """
    ...
    def get_rom_details(self, rom_id):
        ...
        Returns:
            dict: Um dicionário com todos os detalhes da ROM, ou None se não for encontrada.
        """
